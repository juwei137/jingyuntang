// JavaScript Document
const audio = new Audio("../audios/gfzj.mp3");
audio.volume = 0.8;
...
const lyricTime = [0,13,80,114,141,163,197,210,243,271,317,341,353,373,395,430,451,462,471,477];
