// JavaScript Document
const audio = new Audio("../audios/tnsh.mp3");
audio.volume = 0.8;
...
const lyricTime = [0,7,12,37,53,67,89,101,120,125,132,137,143,148,154,157,195];
