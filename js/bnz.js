// JavaScript Document
const audio = new Audio("../audios/bnz.mp3");
audio.volume = 0.8;
...
const lyricTime = [0,2,3,22,59,90,117,119,123,124,128,138,139,159,161,174,201,222,240,258,280];
