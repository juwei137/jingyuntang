// JavaScript Document
const audio = new Audio("../audios/sygz.mp3");
audio.volume = 0.8;
...
const lyricTime = [0,17,33,87,191,221,235,259,271,288,339,393,415,424,427,434,439];
