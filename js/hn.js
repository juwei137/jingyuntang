// JavaScript Document
const audio = new Audio("../audios/hn.mp3");
audio.volume = 0.8;
...
const lyricTime = [0,3,17,33,45,61,75,86,124,144,168,190,206,220,248,264,287,303,325];
